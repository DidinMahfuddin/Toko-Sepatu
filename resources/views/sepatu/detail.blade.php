...
<body>
    ...
    <div class="row">
        ...
        <div class="span12 gallery-single">
            <div class="row">
                <div class="span6">
                    <img src="{{asset('uploadgambar/'.$barang->gambar)}}" class="img-responsive" style=" width: 400px; height: 300px">
                </div>
                <div class="span6">
                    <ul class="project-info">
                        <li><h6>Merk:</h6> {{$barang->merk}}</li>
                        <li><h6>Stok:</h6> {{$barang->stok}}</li>
                        <li><h6>Harga:</h6> {{$barang->harga_jual}}</li>
                        <li><h6>Warna:</h6> {{$barang->warna}}</li>
                        <li><h6>Jenis Sepatu:</h6> {{$barang->id_jenis}}</li>
                    </ul>
